...
Failed cameras create real costs:
- Traffic management loses data for optimization
- Law enforcement misses evidence windows  
- Maintenance teams waste time on manual spot-checks
- Cities pay for cameras that aren't actually working
...
**Failure modes I detect:**
- Lens obstruction (dirt, snow, vandalism)
- Severe blur or defocus
- Lighting failures (washout, darkness)
...
- Synthetically degraded images (clearly labeled as training augmentation)
